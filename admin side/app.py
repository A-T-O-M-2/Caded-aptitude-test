...
def add_question():
    ...
    subsection_choices = {
        'mathematics': [
            ('algebra', 'Algebra'),
            ('mordern_maths', 'Mordern Maths'),
            ('areas_volumes', 'Areas and Volume'),
...
def update_question():
    ...
    if form.validate_on_submit():
        ...
        admin_interface.update_question(str(question_id), question_text, section, subsection)
    ...
    if request.method == 'GET':
        ...
        if question_id:
            ...
            if question:
                ...
                form.question_text.data = question['text']
...
def get_passage():
    ...
    if form.validate_on_submit():
        passage_id = form.passage_id.data
        if passage_id:
            passage_text = admin_interface.get_passage_text(int(passage_id))
            if passage_text:
